...
#### [Artisan](https://cs.laravel-china.org/#artisan) [**](http://laravel-china.org/docs/5.1/artisan)
...
#### [Composer](https://cs.laravel-china.org/#composer) [**](http://getcomposer.org/doc/03-cli.md)
...
#### [Config](https://cs.laravel-china.org/#Configuration) [**](http://laravel-china.org/docs/5.1/configuration)
...
#### [Route](https://cs.laravel-china.org/#routing) [**](http://laravel-china.org/docs/5.1/routing) [**](http://laravel-china.org/docs/5.1/helpers#routing)
...
###### 资源路由 [**](http://laravel-china.org/docs/5.1/controllers#restful-resource-controllers)
...
###### 触发错误 [**](http://laravel-china.org/docs/5.1/routing#throwing-404-errors)
...
###### 路由参数 [**](http://laravel-china.org/docs/5.1/routing#route-parameters)
...
###### HTTP 中间件 [**](http://laravel-china.org/docs/5.1/middleware)
...
#### [Environment](https://cs.laravel-china.org/#app) [**](http://laravel-china.org/docs/5.1/configuration#environment-configuration)
...
#### [Log](https://cs.laravel-china.org/#log) [**](http://laravel-china.org/docs/5.1/errors#logging)
...
###### 记录 SQL 查询语句 [**](http://laravel-china.org/docs/5.1/database#query-logging)
...
#### [URL](https://cs.laravel-china.org/#urls) [**](http://laravel.com/api/5.0/Illuminate/Routing/UrlGenerator.html) [**](http://laravel-china.org/docs/5.1/helpers#urls)
...
#### [Event](https://cs.laravel-china.org/#events) [**](http://laravel-china.org/docs/5.1/events)
...
#### [DB](https://cs.laravel-china.org/#db) [**](http://laravel-china.org/docs/5.1/database)
...
###### 查询语句构造器 [**](http://laravel-china.org/docs/5.1/queries)
...
$jane = DB::table('users')
      ...
      ->first();
// Order By, Group By, 和 Having$users = DB::table('users')
      ->orderBy('name', 'desc')
      ->groupBy('count')
      ->having('count', '>', 100)
      ->get();
...
###### Joins [**](http://laravel-china.org/docs/5.1/queries#joins)
...
###### 聚合 [**](http://laravel-china.org/docs/5.1/queries#aggregates)
...
###### 原始表达句[**](http://laravel-china.org/docs/5.1/queries#raw-expressions)
...
#### [Model](https://cs.laravel-china.org/#eloquent) [**](http://laravel-china.org/docs/5.1/eloquent)

###### 基础使用 [**](http://laravel-china.org/docs/5.1/eloquent#basic-usage)
...
###### 软删除 [**](http://laravel-china.org/docs/5.1/eloquent#soft-deleting)
...
#### [Pagination](https://cs.laravel-china.org/#pagination) [**](http://laravel-china.org/docs/5.1/pagination)
...
#### [Lang](https://cs.laravel-china.org/#localization) [**](http://laravel-china.org/docs/5.1/localization)
...
#### [File](https://cs.laravel-china.org/#files) [**](http://laravel.com/api/5.0/Illuminate/Filesystem/Filesystem.html)
...
#### [UnitTest](https://cs.laravel-china.org/#unittest) [**](http://laravel-china.org/docs/5.1/testing)
...
#### [SSH](https://cs.laravel-china.org/#SSH) [**](http://laravel-china.org/docs/5.1/ssh)
...
#### [Schema](https://cs.laravel-china.org/#chema) [**](http://laravel-china.org/docs/5.1/schema)
...
#### [Input](https://cs.laravel-china.org/#input) [**](http://laravel-china.org/docs/5.1/requests)
...
#### [Cache](https://cs.laravel-china.org/#cache) [**](http://laravel-china.org/docs/5.1/cache)
...
#### [Cookie](https://cs.laravel-china.org/#cookies) [**](http://laravel-china.org/docs/5.1/requests#cookies)
...
#### [Session](https://cs.laravel-china.org/#sessions) [**](http://laravel-china.org/docs/5.1/session)
...
#### [Request](https://cs.laravel-china.org/#requests) [**](http://laravel-china.org/docs/5.1/requests)
...
#### [Response](https://cs.laravel-china.org/#responses) [**](http://laravel-china.org/docs/5.1/responses)
...
#### [Redirect](https://cs.laravel-china.org/#redirects) [**](http://laravel-china.org/docs/5.1/responses#redirects)
...
#### [Container](https://cs.laravel-china.org/#service-container) [**](http://laravel-china.org/docs/5.1/container)
...
#### [Security](https://cs.laravel-china.org/#security)

###### 哈希 [**](http://laravel-china.org/docs/5.1/hashing)
...
#### [Auth](https://cs.laravel-china.org/#auth)

###### 用户认证 [**](http://laravel-china.org/docs/5.1/authentication)
...
###### 用户授权 [**](http://laravel-china.org/docs/5.1/authorization)
...
#### [Mail](https://cs.laravel-china.org/#mail) [**](http://laravel-china.org/docs/5.1/mail)
...
#### [Queue](https://cs.laravel-china.org/#queues) [**](http://laravel-china.org/docs/5.1/queues)
...
#### [Validation](https://cs.laravel-china.org/#validation) [**](http://laravel-china.org/docs/5.1/validation)
...
#### [View](https://cs.laravel-china.org/#views) [**](http://laravel-china.org/docs/5.1/views)
...
#### [Blade](https://cs.laravel-china.org/#blade) [**](http://laravel-china.org/docs/5.1/templates#blade-templating)
...
#### [Form](https://cs.laravel-china.org/#forms) [**](https://github.com/illuminate/html/)
...
#### [HTML](https://cs.laravel-china.org/#html)
...
#### [String](https://cs.laravel-china.org/#str) [**](http://laravel-china.org/docs/5.1/helpers#strings)
...
#### [Helper](https://cs.laravel-china.org/#helpers) [**](http://laravel.com/docs/helpers)
...
#### [Collection](https://cs.laravel-china.org/#collection) [**](https://laravel.com/docs/5.1/collections)
