...
eval 函数用于计算某个字符串，以得到结果；或者用于执行其中的Javascript代码
...
> ![DOM节点树](http://www.w3school.com.cn/i/ct_htmltree.gif)
...
## HTML DOM对象
> * 定义了用户HTML的一系列标准的对象，以及访问和处理HTML文档的标准方法
> * HTML标签对象化
>   -将网页中的每个元素都看作一个对象

> ![常用HTML DOM对象](http://www.codexiu.cn/static/blog/imagesw8/2016/04/01/full/80b443355bfb190ed474b6d8a2546c6dd0d82d5c.jpg)
...
## DHTML其他对象
> ![DHTML对象模型回顾](http://www.codexiu.cn/static/blog/imagesw8/2016/03/31/full/b4bfa746df71b0e4cf59ff64a78d8ccdc99ce163.jpg)
...
> [JavaScript之DOM-8 Event对象(事件概述、事件处理、event对象)](http://jasonteach.blog.51cto.com/5192112/1759084)
...
### even 对象
> 任何事件触发后都会产生一个even对象，记录事件发生时的鼠标位置、键盘按键状态和触发对象等信息
